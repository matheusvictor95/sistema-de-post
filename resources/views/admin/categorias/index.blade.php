...
<h1> Categorias </h1>
    <div class="container">
        <a class="btn btn-secondary" href="{{ route('categoria.create') }}" 
            > Nova Categoria <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <form action="{{ route('categoria.search') }}" method="post" class="form-inline">
            @csrf
